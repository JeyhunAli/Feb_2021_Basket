...
public class FinallyBlock {
	...
	/**
	 * notes about finally block available inside throwkeyword class 
	 * plz take look
	 * @param args
	 */
	...
	public static int getMarks(String name) {
		if (name.equals("Tom")) {
			...
			finally {         // here finally block will execute 
				              // because finally block as we know that there is only case that not executing
				return 100;
			}
