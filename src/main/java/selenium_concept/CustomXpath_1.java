...
public class CustomXpath_1 {
	...
	public static void main(String[] args) {
		...
		//Xpath:
		//1. Absolute Xpath : //html/body/div[3]/div/div[]/ul/li/a   complete adress of the html dom
		...
		//input[@name='email' and @type='text']           more than one attr  and means both the attr have to be there 
		//input[@name='email' or @type='text']            or means either of them  has to be there mostly we use and operator to get exact element

		//input[@value='Login' and @type='submit']
		
		//input[@type='text'] -- 3
		//*[@type='text'] -- 3           * means it will check all the html tag inside dom
		
		//text() function:       is used for to get specific text of the element 
